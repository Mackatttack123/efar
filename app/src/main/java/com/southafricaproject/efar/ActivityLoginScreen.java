...
public class ActivityLoginScreen extends AppCompatActivity {
        ...
        new AlertDialog.Builder(ActivityLoginScreen.this)
                ...
                .setPositiveButton("Accept", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        showPatientInformationProtectionAgreement(name, id);
                    }
                })
    ...
    private void showPatientInformationProtectionAgreement(final String name, final String id){
        new AlertDialog.Builder(ActivityLoginScreen.this)
                .setIcon(android.R.drawable.ic_dialog_alert)
    ...
    private void showLiabilityWaiver(final String name, final String id){
        new AlertDialog.Builder(ActivityLoginScreen.this)
                .setIcon(android.R.drawable.ic_dialog_alert)
    ...
    private void finalLogin(final String name, final  String id){
